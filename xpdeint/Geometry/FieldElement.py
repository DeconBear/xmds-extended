...
__CHEETAH_genTime__ = 1634954792.72671
__CHEETAH_genTimestamp__ = 'Sat Oct 23 13:06:32 2021'
__CHEETAH_src__ = '/home/mattias/xmds-3.0.0/admin/staging/xmds-3.1.0/xpdeint/Geometry/FieldElement.tmpl'
...
class FieldElement(_FieldElement):
    ...
    def description(self, **KWS):
        ...
        ## Generated from @def description: field $name at line 29, col 1.
        trans = KWS.get("trans")
        ...
        write('''field ''')
        _v = VFFSL(SL,"name",True) # '$name' on line 29, col 25
        if _v is not None: write(_filter(_v, rawExpr='$name')) # from line 29, col 25.
    ...
    def defines(self, **KWS):
        ...
        # 
        write('''#define _''')
        _v = VFFSL(SL,"name",True) # '${name}' on line 38, col 10
        if _v is not None: write(_filter(_v, rawExpr='${name}')) # from line 38, col 10.
        write('''_ndims ''')
        _v = VFFSL(SL,"len",False)(VFFSL(SL,"dimensions",True)) # '${len($dimensions)}' on line 38, col 24
        if _v is not None: write(_filter(_v, rawExpr='${len($dimensions)}')) # from line 38, col 24.
        write('''
...
if not hasattr(FieldElement, '_initCheetahAttributes'):
    templateAPIClass = getattr(FieldElement,
