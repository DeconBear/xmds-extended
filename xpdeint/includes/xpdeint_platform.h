...
#if CFG_OSAPI == CFG_OSAPI_WIN32
  static __inline int xpdeint_gettimeofday(struct timeval *tv, void *tz)
  {
    ULARGE_INTEGER timeValue;
    FILETIME fileTime;
    const unsigned long long unixEpochOffset = 116444736000000000ULL;
    ...
    timeValue.QuadPart -= unixEpochOffset;

    tv->tv_sec = (long)(timeValue.QuadPart / 10000000ULL);
    tv->tv_usec = (long)((timeValue.QuadPart % 10000000ULL) / 10ULL);
    return 0;
  }

  #ifndef gettimeofday
    #define gettimeofday(tv, tz) xpdeint_gettimeofday((tv), (tz))
  #endif
#endif
