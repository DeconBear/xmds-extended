...
__CHEETAH_genTime__ = 1634954792.976193
__CHEETAH_genTimestamp__ = 'Sat Oct 23 13:06:32 2021'
__CHEETAH_src__ = '/home/mattias/xmds-3.0.0/admin/staging/xmds-3.1.0/xpdeint/Stochastic/RandomVariables/UniformRandomVariable.tmpl'
...
class UniformRandomVariable(ScriptElement):
    ...
    def makeNoises(self, **KWS):
        ...
        ## CHEETAH: generated from @def makeNoises at line 26, col 1.
        trans = KWS.get("trans")
        ...
        # 
        _v = VFFSL(SL,"generator.constructArrayUniformRandomNumbers",True) # '${generator.constructArrayUniformRandomNumbers}' on line 33, col 1
        if _v is not None: write(_filter(_v, rawExpr='${generator.constructArrayUniformRandomNumbers}')) # from line 33, col 1.
        # 
...
if not hasattr(UniformRandomVariable, '_initCheetahAttributes'):
    templateAPIClass = getattr(UniformRandomVariable,
