...
__CHEETAH_genTime__ = 1634954793.180912
__CHEETAH_genTimestamp__ = 'Sat Oct 23 13:06:33 2021'
__CHEETAH_src__ = '/home/mattias/xmds-3.0.0/admin/staging/xmds-3.1.0/xpdeint/Stochastic/RandomVariables/GaussianSolirteRandomVariable.tmpl'
...
class GaussianSolirteRandomVariable(GaussianRandomVariable):
    ...
    def makeFixedVarianceNoises(self, **KWS):
        ...
        _v = VFFSL(SL,"generator.generatorName",True) # '${generator.generatorName}' on line 32, col 1
        if _v is not None: write(_filter(_v, rawExpr='${generator.generatorName}')) # from line 32, col 1.
        write('''->RandFill_gaussian_FP64(reinterpret_cast<real*>(_active_''')
        _v = VFFSL(SL,"noiseVector.id",True) # '${noiseVector.id}' on line 32, col 84
        if _v is not None: write(_filter(_v, rawExpr='${noiseVector.id}')) # from line 32, col 84.
        write('''), _vector_size);
const real _sigma = sqrt(_var);
#pragma ivdep
for (long _i0 = 0; _i0 < _vector_size; _i0++)
  reinterpret_cast<real*>(_active_''')
        _v = VFFSL(SL,"noiseVector.id",True) # '${noiseVector.id}' on line 36, col 35
        if _v is not None: write(_filter(_v, rawExpr='${noiseVector.id}')) # from line 36, col 35.
        write(''')[_i0] *= _sigma;
''')
        # 
...
if not hasattr(GaussianSolirteRandomVariable, '_initCheetahAttributes'):
    templateAPIClass = getattr(GaussianSolirteRandomVariable,
