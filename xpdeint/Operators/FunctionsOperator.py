...
__CHEETAH_genTime__ = 1634954792.5513587
__CHEETAH_genTimestamp__ = 'Sat Oct 23 13:06:32 2021'
__CHEETAH_src__ = '/home/mattias/xmds-3.0.0/admin/staging/xmds-3.1.0/xpdeint/Operators/FunctionsOperator.tmpl'
...
class FunctionsOperator(Operator):
    ...
    def description(self, **KWS):
        ...
        ## Generated from @def description: Functions operator at line 28, col 1.
        trans = KWS.get("trans")
    ...
    def evaluateOperatorFunctionContents(self, function, **KWS):
        ...
        ## CHEETAH: generated from @def evaluateOperatorFunctionContents($function) at line 30, col 1.
        trans = KWS.get("trans")
        if (not trans and not self._CHEETAH__isBuffering and not callable(self.transaction)):
            trans = self.transaction # is None unless self.awake() was called
        if not trans:
...
''')
        _v = VFFSL(SL,"primaryCodeBlock.codeString",True) # '${primaryCodeBlock.codeString}' on line 33, col 1
        if _v is not None: write(_filter(_v, rawExpr='${primaryCodeBlock.codeString}')) # from line 33, col 1.
        write('''// **********************************************
''')
        # 
...
if not hasattr(FunctionsOperator, '_initCheetahAttributes'):
    templateAPIClass = getattr(FunctionsOperator,
