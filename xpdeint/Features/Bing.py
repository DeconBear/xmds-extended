...
__CHEETAH_genTime__ = 1634954792.9142838
__CHEETAH_genTimestamp__ = 'Sat Oct 23 13:06:32 2021'
__CHEETAH_src__ = '/home/mattias/xmds-3.0.0/admin/staging/xmds-3.1.0/xpdeint/Features/Bing.tmpl'
...
class Bing(_Feature):
    ...
    def description(self, **KWS):
        ...
        ## Generated from @def description: bing at line 26, col 1.
        trans = KWS.get("trans")
    ...
    def mainEnd(self, dict, **KWS):
        ...
        ## CHEETAH: generated from @def mainEnd($dict) at line 29, col 1.
        trans = KWS.get("trans")
        if (not trans and not self._CHEETAH__isBuffering and not callable(self.transaction)):
            trans = self.transaction # is None unless self.awake() was called
        if not trans:
